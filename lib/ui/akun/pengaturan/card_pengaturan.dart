...
class CardPengaturan extends StatelessWidget {
  const CardPengaturan({super.key});
    ...
    return Column(
      children: [
        GestureDetector(
          onTap: () {
            Fluttertoast.showToast(
                msg: "Menu kilat masih dalam pengembangan",
        ...
        GestureDetector(
          onTap: () {
            Fluttertoast.showToast(
                msg: "Keamanan masih dalam pengembangan",
                toastLength: Toast.LENGTH_SHORT,
                gravity: ToastGravity.BOTTOM,
                timeInSecForIosWeb: 1,
                backgroundColor: Colors.red,
        ...
        Padding(
          ...
          child: GestureDetector(
            onTap: () {
              Fluttertoast.showToast(
                  msg: "Update akun masih dalam pengembangan",
                  toastLength: Toast.LENGTH_SHORT,
                  gravity: ToastGravity.BOTTOM,
                  timeInSecForIosWeb: 1,
                  backgroundColor: Colors.red,
