...
class FingerPrintLogout extends StatefulWidget {
  const FingerPrintLogout({super.key});

  @override
  State<FingerPrintLogout> createState() => _FingerPrintLogoutState();
}

class _FingerPrintLogoutState extends State<FingerPrintLogout> {
  ...
  final logger = Logger();
  final String lgnKts1 = dotenv.get('LOGINKATASANDISHAREDPREFERENCES');
    ...
    if (!akunBiometricFingerPrintViewModel.akunBiometricFingerPrintModel.isConnected) {
      ...
      akunBiometricFingerPrintViewModel.validateBiometricFingerPrint().then((result) async {
        ...
        if(statusCode == 200) {
          ...
          // logger.i('kata sandi : ${akunBiometricFingerPrintViewModel.akunBiometricFingerPrintModel.kataSandi}');
          await loginViewModel.clearValue(lgnKts1);
          if(mounted) {
            ...
            Future.delayed(const Duration(seconds: 3), () {
              akunBiometricFingerPrintViewModel.showLogoutFingerPrintNotification();
            });
          }
        }else{
          akunBiometricFingerPrintViewModel.akunBiometricFingerPrintModel.timeStamp = responseBody['timestamp'];
                  ...
                  children: [
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: Text(
                          'Menonaktifkan Biometric Finger Print',
                          style: GoogleFonts.poppins(
                            textStyle: TextStyle(
                              fontSize: 15,
                              fontWeight: FontWeight.w600,
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        width: MediaQuery.of(context).size.width * 0.95,
                        child: Text(
                          'Masukan kata sandi akun anda untuk menyatakan bahwa anda tidak ingin menggunakan fitur Biometric Finger Print !!!',
                          style: GoogleFonts.poppins(
                            textStyle: TextStyle(
                              fontSize: 14,
                    ...
                    Container(
                      ...
                      child: TextButton(
                        ...
                        child: const Text(
                          'Non Aktifkan Biometric Finger Print',
                          style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w600,
                            color: Colors.white,
