...
class _CardSimpananState extends State<CardSimpanan> {
  ...
  Widget build(BuildContext context) {
    ...
    if(
    widget.rekeningCardSimpananViewModel.rekeningCardSimpananModel.savings == [] ||
      widget.rekeningCardSimpananViewModel.rekeningCardSimpananModel.savings.isEmpty ||
        widget.rekeningCardSimpananViewModel.rekeningCardSimpananModel.savings[0].productName == 'N/A'
    ) {
      return Center(
        child: Text(
