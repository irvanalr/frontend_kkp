...
class _CardPembiayaanState extends State<CardPembiayaan> {
  ...
  Widget build(BuildContext context) {
    ...
    if(
    widget.rekeningCardPembiayaanViewModel.rekeningCardPembiayaanModel.loans == [] ||
      widget.rekeningCardPembiayaanViewModel.rekeningCardPembiayaanModel.loans.isEmpty ||
        widget.rekeningCardPembiayaanViewModel.rekeningCardPembiayaanModel.loans[0].productName == 'N/A'
    ) {
      return Center(
        child: Text(
