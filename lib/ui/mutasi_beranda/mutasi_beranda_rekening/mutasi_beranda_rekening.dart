...
class MutasiBerandaRekening extends StatefulWidget {
  final MutasiBerandaViewModel mutasiBerandaViewModel;
  const MutasiBerandaRekening({
    super.key,
    required this.mutasiBerandaViewModel,
  });

  @override
  State<MutasiBerandaRekening> createState() => _MutasiBerandaRekeningState();
}

class _MutasiBerandaRekeningState extends State<MutasiBerandaRekening> {
  final logger = Logger();
    ...
    return FutureBuilder(
      future: Future.delayed(
        const Duration(milliseconds: 1500),
            () => widget.mutasiBerandaViewModel.informasiRekening(),
      ),
  ...
  Widget _buildInformasiRekeningCard() {
    final savings = widget.mutasiBerandaViewModel.mutasiBerandaModel.savings;
