...
class MutasiRekeningSimpananPokokRekening extends StatefulWidget {
  final MutasiRekeningSimpananPokokViewModel mutasiRekeningSimpananPokokViewModel;
  const MutasiRekeningSimpananPokokRekening({
    super.key,
    required this.mutasiRekeningSimpananPokokViewModel,
  });

  @override
  State<MutasiRekeningSimpananPokokRekening> createState() => _MutasiRekeningSimpananPokokRekeningState();
}

class _MutasiRekeningSimpananPokokRekeningState extends State<MutasiRekeningSimpananPokokRekening> {
  final logger = Logger();
    ...
    return FutureBuilder(
      future: Future.delayed(
        const Duration(milliseconds: 1500),
            () => widget.mutasiRekeningSimpananPokokViewModel.informasiRekening(),
      ),
  ...
  Widget _buildInformasiRekeningCard() {
    final savings = widget.mutasiRekeningSimpananPokokViewModel.mutasiRekeningSimpananPokokModel.savings;
